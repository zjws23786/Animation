...
public class MyPorterDuffXfermode extends View {
    ...
    public MyPorterDuffXfermode(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public MyPorterDuffXfermode(Context context, AttributeSet attrs, int defStyle) {
